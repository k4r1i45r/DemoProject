...
namespace DemoProject.Controllers
{
    public class ParticipantController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ParticipantId,FirstName,LastName")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParticipantId,FirstName,LastName")] Participant participant)
        {
